...
class TestSaleGlobalDiscountAmount(SavepointCase):
    ...
    def test_create_sale_multi_tax_with_global_discount(self):
        self.assertEqual(self.sale_multi_tax.amount_untaxed, 300.00)
    ...
    def test_write_sale_multi_tax_with_change_global_discount(self):
        self.sale_multi_tax.write({"global_discount_amount": 45.00})
        self.assertEqual(self.sale_multi_tax.amount_untaxed, 305.00)
    ...
    def test_write_sale_multi_tax_with_null_global_discount(self):
        self.sale_multi_tax.write({"global_discount_amount": 0.00})
        self.assertEqual(self.sale_multi_tax.amount_untaxed, 350.00)
